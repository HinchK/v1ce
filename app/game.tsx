    ...
    <ScrollView style={{ backgroundColor: c.background }} contentContainerStyle={s.page}>
      ...
      <View style={s.tabs}>
        <TouchableOpacity onPress={() => setGame("run")} style={[s.tab, { borderColor: c.foreground, backgroundColor: game === "run" ? c.foreground : c.background }]}>
          <Text style={{ color: game === "run" ? c.background : c.foreground, fontWeight: "900" }}>SOBRIETY RUN</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setGame("snake")} style={[s.tab, { borderColor: c.foreground, backgroundColor: game === "snake" ? c.foreground : c.background }]}>
          <Text style={{ color: game === "snake" ? c.background : c.foreground, fontWeight: "900" }}>JAYWALKER</Text>
        </TouchableOpacity>
      </View>
...
const s = StyleSheet.create({
  ...
  back: { fontSize: 11, fontWeight: "900", letterSpacing: 2, marginBottom: 30 },
  kicker: { fontSize: 11, letterSpacing: 5, fontWeight: "800" },
  title: { fontSize: 54, fontWeight: "900", marginBottom: 22 },
