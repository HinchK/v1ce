...
export default function SobrietyRunGame(){
 ...
 const d=useRef({playerX:W/2-PLAYER/2,playerY:G-PLAYER,velY:0,jump:false,obstacles:[] as Ob[],coins:[] as Coin[],speed:INITIAL_SPEED,spawn:0,time:0,level:1,boss:null as null|{x:number;y:number;width:number;height:number;attack:number;health:number},projectiles:[] as Projectile[],throwing:null as null|Projectile,scroll:0,last:Date.now()});
 const reset=useCallback(()=>{d.current={playerX:W/2-PLAYER/2,playerY:G-PLAYER,velY:0,jump:false,obstacles:[],coins:[],speed:INITIAL_SPEED,spawn:0,time:0,level:1,boss:null,projectiles:[],throwing:null,scroll:0,last:Date.now()};setScore(0);setLevel(1);setGameState("start")},[]);
